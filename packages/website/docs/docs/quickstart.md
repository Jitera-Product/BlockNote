...
```
npm install @jitera/blocknote-core @blocknote/react
```
...
As well as `BlockNoteView` and `useBlockNote`, we import `@jitera/blocknote-core/style.css` to provide default styling for the editor.
